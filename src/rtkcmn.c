...
static char codepris[7][MAXFREQ][16]={  /* code priority for each freq-index */
    ...
    {"CLSXZ"   ,"LSX"       ,"IQXDPZ"  ,"LSXEZ"  ,""       ,""}, /* QZS */
    {"C"       ,"IQX"       ,""        ,""       ,""       ,""}, /* SBS */
    {"IQXDANP" ,"DXP"    ,"IQXDPZ"    ,"IQXA"    ,"DPX"    ,""}, /* BDS */
    {"ABCX"    ,"ABCX"      ,""        ,""       ,""       ,""}  /* IRN */

    /* B1I+B2I */
    /* (B2I在rinex3.04版本中是B2b的I信道，在rinex4.0版本中将B2I独立出来。b34k采用的是rinex3.04版本) */
    //{"CPYWMNSLX","CPWYMNDLSX","IQX"     ,""       ,""       ,"" }, /* GPS */
    //{"CPABX"   ,"CPABX"     ,"IQX"     ,""       ,""       ,""}, /* GLO */
    //{"CABXZ"   ,"XIQ"       ,"XIQ"     ,"ABCXZ"  ,"IQX"    ,""}, /* GAL */
    //{"CLSXZ"   ,"LSX"       ,"IQXDPZ"  ,"LSXEZ"  ,""       ,""}, /* QZS */
    //{"C"       ,"IQX"       ,""        ,""       ,""       ,""}, /* SBS */
    //{"IQXDANP" ,"QXIDPZ"    ,"IQXDPZ"    ,"IQXA"    ,"DPX"    ,""}, /* BDS */
    //{"ABCX"    ,"ABCX"      ,""        ,""       ,""       ,""}  /* IRN */
    ...
    //{"CLSXZ"   ,"LSX"       ,"IQXDPZ"  ,"LSXEZ"  ,""       ,""}, /* QZS */
    //{"C"       ,"IQX"       ,""        ,""       ,""       ,""}, /* SBS */
    //{"IQXPDAN" ,"QXAI"    ,"IQXDPZ"    ,"QIXDPZ"    ,"DPX"    ,""}, /* BDS */
    //{"ABCX"    ,"ABCX"      ,""        ,""       ,""       ,""}  /* IRN */
    ...
    //{"CLSXZ"   ,"LSX"       ,"IQXDPZ"  ,"LSXEZ"  ,""       ,""}, /* QZS */
    //{"C"       ,"IQX"       ,""        ,""       ,""       ,""}, /* SBS */
    //{"PQXDANI" ,"DXP"    ,"IQXDPZ"    ,"IQXA"    ,"DPX"    ,""}, /* BDS */
    //{"ABCX"    ,"ABCX"      ,""        ,""       ,""       ,""}  /* IRN */
    ...
    //{"CLSXZ"   ,"LSX"       ,"IQXDPZ"  ,"LSXEZ"  ,""       ,""}, /* QZS */
    //{"C"       ,"IQX"       ,""        ,""       ,""       ,""}, /* SBS */
    //{"PQXDANI" ,"QXDIPZ"    ,"IQXDPZ"    ,"IQXA"    ,"DPX"    ,""}, /* BDS */
    //{"ABCX"    ,"ABCX"      ,""        ,""       ,""       ,""}  /* IRN */
    ...
    //{"CLSXZ"   ,"LSX"       ,"IQXDPZ"  ,"LSXEZ"  ,""       ,""}, /* QZS */
    //{"C"       ,"IQX"       ,""        ,""       ,""       ,""}, /* SBS */
    //{"PQXDANI" ,"QXAI"    ,"IQXDPZ"    ,"QIXDPZ"    ,"DPX"    ,""}, /* BDS */
    //{"ABCX"    ,"ABCX"      ,""        ,""       ,""       ,""}  /* IRN */
    ...
    //{"CLSXZ"   ,"LSX"       ,"IQXDPZ"  ,"LSXEZ"  ,""       ,""}, /* QZS */
    //{"C"       ,"IQX"       ,""        ,""       ,""       ,""}, /* SBS */
    //{"IQXDPZ" ,"QXAI"    ,"IQXDPZ"    ,"IQXA"    ,"DPX"    ,""}, /* BDS */
    //{"ABCX"    ,"ABCX"      ,""        ,""       ,""       ,""}  /* IRN */
    ...
    //{"CLSXZ"   ,"LSX"       ,"IQXDPZ"  ,"LSXEZ"  ,""       ,""}, /* QZS */
    //{"C"       ,"IQX"       ,""        ,""       ,""       ,""}, /* SBS */
    //{"IQXPDAN" ,"QIXDPZ"    ,"IQXDPZ"    ,"IQXA"    ,"DPX"    ,""}, /* BDS */
    //{"ABCX"    ,"ABCX"      ,""        ,""       ,""       ,""}  /* IRN */
...
static int code2freq_GPS(uint8_t code, double *freq)
{
    ...
    switch (obs[0]) {
        ...
        case '5': *freq=FREQL5; return 7; /* L5 */
    }

    /* L1C+L5Q */
    //switch (obs[0]) {
    //case '1': *freq = FREQL1; return 0; /* L1 */
    //case '2': *freq = FREQL2; return 7; /* L2 */
    //case '5': *freq = FREQL5; return 1; /* L5 */
    //}

    /* L2X+L5Q/L2W+L5Q */
    //switch (obs[0]) {
    //case '1': *freq = FREQL1; return 7; /* L1 */
    //case '2': *freq = FREQL2; return 0; /* L2 */
    //case '5': *freq = FREQL5; return 1; /* L5 */
    //}
...
static int code2freq_BDS(uint8_t code, double* freq)
{
    ...
    /* 在这里除了使用的频率以外其余的均设为7，使得这些频率在codepris中直接被拒绝 */
    /* B1I+B2a+L1C+L2W/X */
    switch (obs[0]) {
        case '1': *freq=FREQL1;    return 7; /* B1C */
        case '2': *freq=FREQ1_CMP; return 0; /* B1I */
        case '7': *freq=FREQ2_CMP; return 7; /* B2b */
        case '5': *freq=FREQL5;    return 1; /* B2a */
        case '6': *freq=FREQ3_CMP; return 7; /* B3 */
        case '8': *freq=FREQE5ab;  return 7; /* B2ab */
    }
    ...
    //    case '5': *freq = FREQL5;    return 7; /* B2a */
    //    case '6': *freq = FREQ3_CMP; return 7; /* B3 */
    //    case '8': *freq = FREQE5ab;  return 7; /* B2ab */
    //}
    ...
    //switch (obs[0]) {
    //    case '1': *freq = FREQL1;    return 0; /* B1C */
    //    case '2': *freq = FREQ1_CMP; return 7; /* B1I */
    //    case '7': *freq = FREQ2_CMP; return 7; /* B2b */
    //    case '5': *freq = FREQL5;    return 1; /* B2a */
    //    case '6': *freq = FREQ3_CMP; return 7; /* B3 */
    //    case '8': *freq = FREQE5ab;  return 7; /* B2ab */
    ...
    //    case '2': *freq = FREQ1_CMP; return 7; /* B1I */
    //    case '7': *freq = FREQ2_CMP; return 7; /* B2b */
    //    case '5': *freq = FREQL5;    return 0; /* B2a */
    //    case '6': *freq = FREQ3_CMP; return 1; /* B3 */
    //    case '8': *freq = FREQE5ab;  return 7; /* B2ab */
    //}
    ...
    //    case '1': *freq = FREQL1;    return 7; /* B1C */
    //    case '2': *freq = FREQ1_CMP; return 7; /* B1I */
    //    case '7': *freq = FREQ2_CMP; return 0; /* B2b */
    //    case '5': *freq = FREQL5;    return 7; /* B2a */
    //    case '6': *freq = FREQ3_CMP; return 1; /* B3 */
    //    case '8': *freq = FREQE5ab;  return 7; /* B2ab */
    //}
